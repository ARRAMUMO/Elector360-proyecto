                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {personas.map((persona) => (
                    <tr key={persona._id || persona.documento} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            {persona.puesto?.municipio || ''} {persona.puesto?.zona ? `· Zona ${persona.puesto.zona}` : ''} {persona.puesto?.mesa ? `- Mesa ${persona.puesto.mesa}` : ''}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          title={persona.notaVoto || ''}
                          className={`px-2 py-0.5 text-xs font-medium rounded-full ${votoColors[persona.estadoVoto] || votoColors.SIN_DATOS}`}
                        >
                ...
                <div className="p-4 pb-3">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="relative flex-shrink-0 flex flex-col items-end gap-1">
                      ...
                      {persona.estadoVoto && persona.estadoVoto !== 'SIN_DATOS' && (
                        <span title={persona.notaVoto || ''} className={`px-2 py-0.5 text-xs font-medium rounded-full ${votoColors[persona.estadoVoto]}`}>
                          {votoLabels[persona.estadoVoto]}
                        </span>
                      )}
                      {(() => {
                        const rpa = persona.estadoRPA;
